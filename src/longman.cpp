...
floating_t details::mean_longitude_moon(floating_t time) noexcept { // sm_rad
  ...
  const auto sm_rad =
	...
	+ details::deg_to_rad((1336. * constants::rev_sec + 1108406.05) / 3600.)
		* time
...
floating_t
  ...
  const auto pm_rad =
	...
	+ details::deg_to_rad((11. * constants::rev_sec + 392522.51) / 3600.) * time
...
floating_t details::longitude_of_moons_ascending_node(
  ...
  const auto N_rad =
	...
	- details::deg_to_rad((5. * constants::rev_sec + 482911.24) / 3600.) * time
